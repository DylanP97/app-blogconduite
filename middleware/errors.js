module.exports.signUpErrors = (err) => {
    ...
    if (err.message.includes("password"))
      errors.password = "Le mot de passe doit contenir 6 à 100 caractères avec une majuscule, une minuscule, un nombre, un caractère spécial et ne pas contenir d'espaces.";
